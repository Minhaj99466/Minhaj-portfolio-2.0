        ...
        <div className="flex flex-col xl:flex-row  justify-between items-center xl:pt-8 xl:pb-16">
          <div className="text-center xl:text-left order-2 xl:order-none ">
            ...
            <div className="flex flex-col xl:flex-row gap-8 items-center">
              <Button variant="outline" size="lg" className="hover:text-primary uppercase flex items-center gap-2 hover-transition-all duration-700">Download Resume  <FaFileDownload className="text-xl "/></Button>
